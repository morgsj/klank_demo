...
function RegisterWithGoogle({ isHost }: {isHost: boolean}) {
    return (
        <Button variant="none" className="register-btn register-google" onClick={() => signInWithGoogle([ isHost ? "host" : "performer" ])}>
            <span>
                <img id="google-logo" src={require("../../../images/google-logo.png")} alt="Google Logo"/>
